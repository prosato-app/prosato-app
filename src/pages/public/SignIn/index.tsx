...
import useController from "@/pages/public/SignIn/useController"
...
const SignIn = () => {
	...
	return (
		<div className={`w-screen h-screen flex items-center justify-center ph-[552px] bg-[${customStyles.colors.primary[100]}]`}>
